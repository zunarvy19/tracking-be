import { pgTable, text, timestamp, boolean, uuid, varchar, numeric, date, pgEnum, uniqueIndex, index, } from "drizzle-orm/pg-core";
// ─── Better Auth Tables ─────────────────────────────────────────────────────
...
export const budgets = pgTable("budgets", {
    ...
    uniqueIndex("idx_budgets_user_category_period").on(table.userId, table.categoryId, table.period),
]);

...
export const dashboardService = {
    async getStats(userId) {
        ...
        const currentMonth = await db
            ...
            .from(transactions)
            .where(and(eq(transactions.userId, userId), gte(transactions.date, currentMonthStart), lte(transactions.date, currentMonthEnd)))
        ...
        const lastMonth = await db
            ...
            .from(transactions)
            .where(and(eq(transactions.userId, userId), gte(transactions.date, lastMonthStart), lte(transactions.date, lastMonthEnd)))
            .groupBy(transactions.type);
        ...
        return {
            ...
            balanceTrend: calcTrend(balance, allTime.income - last.income - (allTime.expense - last.expense)),
        };
    },
